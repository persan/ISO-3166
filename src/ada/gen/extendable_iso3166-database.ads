...
private package Extendable_ISO3166.Database is
   ...
   Ukraine_Entry : aliased constant Country :=
      (Name => Ukraine_Name'Access,
       ...
       Sub_Region_Code =>  151,
       Intermediate_Region_Code =>  0);
   Undefined_Name : aliased constant String := "<Undefined>";
   Undefined_Alpha_2 : aliased constant String := "XX";
   Undefined_Alpha_3 : aliased constant String := "XXX";
   Undefined_Iso_3166_2 : aliased constant String := "ISO XXXX-X:XX";
   Undefined_Region : aliased constant String := "";
   Undefined_Sub_Region : aliased constant String := "";
   Undefined_Intermediate_Region : aliased constant String := "";
   Undefined_Entry : aliased constant Country :=
      (Name => Undefined_Name'Access,
       Alpha_2 => Undefined_Alpha_2'Access,
       Alpha_3 => Undefined_Alpha_3'Access,
       Iso_3166_2 => Undefined_Iso_3166_2'Access,
       Nationality_Code =>  0,
       Region => Undefined_Region'Access,
       Sub_Region => Undefined_Sub_Region'Access,
       Intermediate_Region => Undefined_Intermediate_Region'Access,
       Region_Code =>  0,
       Sub_Region_Code =>  0,
       Intermediate_Region_Code =>  0);
   ...
   land_Islands_Entry : aliased constant Country :=
      (Name => land_Islands_Name'Access,
       ...
       Sub_Region_Code =>  154,
       Intermediate_Region_Code =>  0);
   Data : constant array (Mappings.Nationality_Enum) of Nationality_Access :=
     (Mappings.Afghanistan => Afghanistan_Entry'Access,
      ...
      Mappings.Undefined => Undefined_Entry'Access,
