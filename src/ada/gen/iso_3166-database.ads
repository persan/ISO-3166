...
private package ISO_3166.Database is
   ...
   Undefined_Alpha_2 : aliased constant String := "<Undefined>";
   Undefined_Alpha_3 : aliased constant String := "<Undefined>";
   Undefined_Iso_3166_2 : aliased constant String := "<Undefined>";
   Undefined_Region : aliased constant String := "<Undefined>";
   Undefined_Sub_Region : aliased constant String := "<Undefined>";
   Undefined_Intermediate_Region : aliased constant String := "<Undefined>";
